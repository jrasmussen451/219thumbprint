...
function minicart() {
    ...
    function template(){
        return [
            '<style>',
            '.minicart { padding: 15px 15px 15px 0; float: right; cursor: pointer;color: #fffff; min-width:300px; text-align:right;}',
            '@media (max-width: 768px) {.minicart { min-width:auto; } }',
            '.text-muted {color: #000000;}',
            '.minicart .fa-shopping-cart {position: relative;top: 3px;padding-right: 5px; font-size:1.5em; color: #ffffff}',
            ...
            '    <div class="minicart carta">',
            '        <span ng-bind="cartCount" class="badge"></span><span class="hidden-xs" style="color: #ffffff"> {{currentOrder.Total | currency }}</span>&nbsp;<i class="fa fa-shopping-cart"></i>&nbsp;  <i class="fa fa-caret-down text-muted"></i>',
            '        <div class="minicart-detail">',
            '            <i class="fa fa-caret-up fa-2x text-muted"></i>',
            '            <ul>',
            ...
            '                </div>',
            '                <div class="col-xs-6">',
            '                    <a class="btn btn-success btn-block" ng-click="cartCheckOut()">Checkout</a>',
            '                </div>',
            '            </div>',
            '        </div>',
            '    </div>',
